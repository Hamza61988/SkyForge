  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-black text-white overflow-hidden" style={{ backgroundImage: "url('/public/sky.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <div className="flex flex-row justify-between items-center px-16 py-20 relative z-10">
        ...
        >
          <motion.h1
            className="text-6xl font-extrabold mb-6 leading-tight skyforge-glow"
          ...
          <motion.a
            href="/join"
            className="px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-400 hover:scale-105 transition-all duration-300 rounded-lg shadow-lg"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
